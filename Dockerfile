...
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-vsphere/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-vsphere/go/pkg go install github.com/shanduur/dis-vulncheck@${DIS_VULNCHECK_VERSION} \
...
WORKDIR /src
RUN --mount=type=cache,target=/root/.cache/go-build,id=omni-infra-provider-vsphere/root/.cache/go-build --mount=type=cache,target=/go/pkg,id=omni-infra-provider-vsphere/go/pkg dis-vulncheck -tool=false ./...
