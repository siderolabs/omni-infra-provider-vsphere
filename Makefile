...
#
# Generated on 2025-10-31T17:56:21Z by kres cd5a938.
...
all: unit-tests omni-infra-provider-vsphere image-omni-infra-provider-vsphere lint
...
.PHONY: $(ARTIFACTS)/omni-infra-provider-vsphere-linux-amd64
$(ARTIFACTS)/omni-infra-provider-vsphere-linux-amd64:
	@$(MAKE) local-omni-infra-provider-vsphere-linux-amd64 DEST=$(ARTIFACTS)

.PHONY: omni-infra-provider-vsphere-linux-amd64
omni-infra-provider-vsphere-linux-amd64: $(ARTIFACTS)/omni-infra-provider-vsphere-linux-amd64  ## Builds executable for omni-infra-provider-vsphere-linux-amd64.

.PHONY: omni-infra-provider-vsphere
omni-infra-provider-vsphere: omni-infra-provider-vsphere-linux-amd64  ## Builds executables for omni-infra-provider-vsphere.
...
.PHONY: image-omni-infra-provider-vsphere
